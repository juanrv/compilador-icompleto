...
namespace lectorArchivo.Transversal
{
	public class ComponenteLexico
	{
		...
		public override string ToString()
		{
			...
			informacion.Append("Posicion Inicial de la linea: ").Append(ObetenerPosicionInicial()).Append(Environment.NewLine);
			informacion.Append("Posicion final de la linea: ").Append(ObtenerPosicionFinal()).Append(Environment.NewLine);
